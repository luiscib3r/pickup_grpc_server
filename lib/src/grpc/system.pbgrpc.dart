...
class SystemServiceClient extends $grpc.Client {
  static final _$getSystemInfo = $grpc.ClientMethod<$0.NoParams, $0.Status>(
      '/SystemService/getSystemInfo',
      ($0.NoParams value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Status.fromBuffer(value));
  static final _$getMemoryStatus = $grpc.ClientMethod<$0.NoParams, $0.Memory>(
      '/SystemService/getMemoryStatus',
      ($0.NoParams value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Memory.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Status> getSystemInfo($0.NoParams request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getSystemInfo, request, options: options);
  }

  $grpc.ResponseFuture<$0.Memory> getMemoryStatus($0.NoParams request,
      {$grpc.CallOptions? options}) {
...
abstract class SystemServiceBase extends $grpc.Service {
  ...
  SystemServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.NoParams, $0.Status>(
        'getSystemInfo',
        getSystemInfo_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.NoParams, $0.Memory>(
        'getMemoryStatus',
        getMemoryStatus_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.NoParams.fromBuffer(value),
        ($0.Memory value) => value.writeToBuffer()));
  }

  $async.Future<$0.Status> getSystemInfo_Pre(
      $grpc.ServiceCall call, $async.Future<$0.NoParams> request) async {
    return getSystemInfo(call, await request);
  }

  $async.Future<$0.Memory> getMemoryStatus_Pre(
      $grpc.ServiceCall call, $async.Future<$0.NoParams> request) async {
    return getMemoryStatus(call, await request);
  }

  $async.Future<$0.Status> getSystemInfo(
      $grpc.ServiceCall call, $0.NoParams request);
  $async.Future<$0.Memory> getMemoryStatus(
      $grpc.ServiceCall call, $0.NoParams request);
}
